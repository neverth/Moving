...
public class BookBorrowController {
    ...
    @PostMapping("/update")
    public Result<BookBorrowVO> updateUser(@RequestBody BookBorrowForm form) {
        BookBorrowVO bookBorrowVO;
        try {
            bookBorrowVO = bookBorrowService.updateBorrow(form);
        ...
        if (bookBorrowVO != null) {
            return Result.success(bookBorrowVO);
        }
